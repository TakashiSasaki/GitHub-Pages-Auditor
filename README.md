...
*   **Current Milestone**: Milestone 1.5.4 (Release Gate Generalization & Stale PR Closure Baseline)
...
- **Commit Format**: All changes must culminate in a descriptive English commit message outlining the milestone and patch alignment (e.g., `chore(release): generalize release gate for 1.5.4`).
