...
Version: `1.7.6` (Release Candidate Reality Alignment & Operator Handoff)
...
*   **Current Milestone**: Milestone 1.7.6 (Release Candidate Reality Alignment & Operator Handoff)
...
- **Commit Format**: All changes must culminate in a descriptive English commit message outlining the milestone and patch alignment (e.g., `chore(release): close development-complete baseline at 1.7.6`).
