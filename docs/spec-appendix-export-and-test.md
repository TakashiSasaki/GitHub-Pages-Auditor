...
Examples: `github-pages-auditor.export.v2`

For comprehensive structural layouts, see:
* **docs/export-schema-vocabulary.md** for a complete 1:1 mapping table of all CSV fields.
* **docs/export-schema-v2.md** for the nested structures JSON layout specification.
...
* **Permanent Identifiers Assigned**:
  - **Version 2**: `urn:uuid:7d0f98be-8cba-49c5-84dc-66914b5da3f2`
