...
1. **JSON Export Sample**: `examples/github-pages-auditor-export-v2.sample.json`
...
3. **CSV Export Sample**: `examples/github-pages-auditor-export.sample.csv`
   - Contains exactly 27-column spreadsheet representation derived from the flat V2 data.
...
- **V2 Fields**: `hasPages: false`, `pagesEnabled: false`, `deploymentMethod: "not_applicable"`
