# GitHub Pages Auditor - Export Schema Vocabulary

This volume provides a rigorous, property-by-property dictionary of the application's CSV flat structure semantics, showing how they translate to the current V2 JSON layout.

External consumers can find sample JSON payloads for evaluation under `examples/github-pages-auditor-export-v2.sample.json` and the flat CSV data under `examples/github-pages-auditor-export.sample.csv`.
...
| JSON Path | Flat CSV Name | Category | Nullable? | Readability | GitHub Source Field | Meaning / Intended Semantics | Recommended V2 Name |
| :--- | :--- | :--- | :---: | :---: | :--- | :--- | :--- |
...
| JSON Path | Flat CSV Name | Category | Nullable? | Readability | Meaning / Intended Semantics | Recommended V2 Name |
| :--- | :--- | :--- | :---: | :---: | :--- | :--- |
...
This section details the formal conclusions reached regarding current property mappings inside the flat structure to prevent systematic logic drift:
