...
Version: `1.5.0` (TTL-Ready Foundation)
...
In **Milestone 1.5.0**, the data structures have been fully upgraded to be **TTL-Ready**. All guest-created documents carry clean, standardized lifecycle fields.
