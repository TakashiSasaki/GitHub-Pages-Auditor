...
1. **Version 2 (V2) - Official JSON Schema:** Deeply-nested structure designed for system-to-system interchange. `schemaVersion: "github-pages-auditor.export.v2"`.
2. **CSV - Spreadsheet Export:** Flat spreadsheet export format.
...
The `findings` output array is automatically aggregated.
