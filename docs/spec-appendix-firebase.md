...
Anonymous-to-Google upgrade or credential linking is not required. Do not implement automatic migration unless the specification is updated.

5. Firestore Persistence (MVP)
