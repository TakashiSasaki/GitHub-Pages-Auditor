...
This document serves as the authoritative index of all major maintenance contracts for the GitHub Pages Auditor application. As the project is development-complete and in maintenance mode (Milestone 1.6.22), these contracts define the boundaries of accepted runtime behavior, security, and UI optimizations.
